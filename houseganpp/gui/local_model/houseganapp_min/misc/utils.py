...
from assets.graphs.path import graphs_path
...
#     print(len(edgecolors))
    ...
    true_graph_path = os.path.join(graphs_path, "_true_graph.jpg")
    plt.savefig(true_graph_path, format="jpg")
    plt.close('all')
    rgb_im = Image.open(true_graph_path)
