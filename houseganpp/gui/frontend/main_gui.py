...
from frontend import frames
from frontend.frames import WhiteBGFrame, CreateEditCanvasFrame, CreateCanvasOptionsFrame, CreateCanvasLegendFrame, CreateMainFrame
from frontend.styles import MyStyle

import json
from backend import edit_json, canvas_interactions
...
class FileHandler():
    """Handles file opening and processing and updates the frontend accordingly."""
    ...
    def process_file(self, extension):
        """Processes the opened json file and initialized the frontend components"""
        ...
        if extension == JSON_EXTENSION:
            ...
            reorganized_json = edit_json.get_simplified_format_json(original_data)
    ...
    def initialize_edit_json_gui(self, reorganized_json):
        """Initializes the frontend components for editing the json file."""
        canvas_interactions.init_gui(self.edit_json_frame, MAX_X, MAX_Y, reorganized_json, "init")
