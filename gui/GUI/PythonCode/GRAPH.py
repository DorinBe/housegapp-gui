...
pygame.display.set_caption("Create bubble diagram")
...
msg_font = pygame.font.Font('roboto.ttf', 20)
...
def show_edges():
    ...
    for i in range(len(blue_edges)):
            pygame.draw.line(screen,PINKTEXT,(nodes[blue_edges[i][0]][0]+16,nodes[blue_edges[i][0]][1]+16),(nodes[blue_edges[i][1]][0]+16,nodes[blue_edges[i][1]][1]+16),2)
