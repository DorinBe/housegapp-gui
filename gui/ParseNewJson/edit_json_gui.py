...
def add_random_door():
    ...
    if room_types == ['']:
        room_types = ['0','0','0','0']
    random_edges = [[400,90,400,94,door_type, int(room_types[0])],
                    [400,94,412,94,door_type, int(room_types[1])],
                    [412,94,412,90,door_type, int(room_types[2])],
                    [412,90,400,90,door_type, int(room_types[3])]]
